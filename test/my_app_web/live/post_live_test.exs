defmodule MyAppWeb.PostLiveTest do
  ...
  import MyApp.TimelineFixtures

  @create_attrs %{body: "some body", likes_count: "some likes_count", repost_count: "some repost_count", username: "some username"}
  @update_attrs %{body: "some updated body", likes_count: "some updated likes_count", repost_count: "some updated repost_count", username: "some updated username"}
